...
class RoboticArmGUI:
    def __init__(self, root, arduino, kinematics):
        ...
        # Removed initial assignment of PIXELS_PER_CM
                    ...
                    if red_center or blue_object:
                        ...
                        if red_center:
                            ...
                            if abs(theta) > self.THETA_THRESHOLD:
                                ...
                                self.stopped = False  # The robot is moving
                            else:
                                if not self.stopped:
                                    print("Object is centered. Sending stop command.")
    ...
    def send_command_to_robot(self, theta):
        ...
        """
        if theta == 0:
            # Object is centered; send stop command
            if not self.stopped:
                print("Theta is zero. Sending stop command.")
                self.arduino.send_command("s")
                self.stopped = True
            return
    ...
    def detect_red_circle(self, frame):
        ...
        # Set pixels per cm for circles
        self.PIXELS_PER_CM = 20.20
    ...
    def detect_blue_rectangle(self, frame):
        ...
        # Set pixels per cm for rectangles
        self.PIXELS_PER_CM = 19.80
