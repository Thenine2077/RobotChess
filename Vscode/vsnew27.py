...
class RoboticArmGUI:
    ...
    def setup_ui(self):
        ...
        # self.create_camera_controls(font_style)
    ...
    # Removed create_camera_controls method

    # Removed adjust_brightness and adjust_exposure methods
    ...
    def plot_robot_arm(self, theta1, theta2, theta3, theta4):
        ...
        # Labels and title
        self.ax.set_xlabel('X-axis (mm)', labelpad=20)
        self.ax.set_ylabel('Y-axis (mm)', labelpad=20)
        self.ax.set_zlabel('Z-axis (mm)', labelpad=20)
